...
func _on_background_value_changed(to: GradientTexture1D) -> void: field_changed('bg_color', to)
...
func _on_light_1_color_value_changed(to: Color) -> void: field_changed('light1_color', to)
func _on_light_2_color_value_changed(to: Color) -> void: field_changed('light2_color', to)
func _on_light_1_position_value_changed(to: Vector3) -> void: field_changed('light1_position', to)
func _on_light_2_position_value_changed(to: Vector3) -> void: field_changed('light2_position', to)
